...
<head>
	<meta charset="UTF-8">
	<title>InFigure | Headline</title>
	<link rel="icon" href="C:\Users\202310714\Downloads\WEBDESIGN-20240519T231027Z-001\WEBDESIGN\PICTURES\InFigure.png">
	...
	<style>
		*{
		...
		body {
            ...
            background-image: linear-gradient(transparent, transparent, #7fc3e1, #7fc3e1),url("https://i.pinimg.com/736x/68/fd/64/68fd641e143e87a5bf9f999d315b9f68.jpg");
        ...
        .form-box {
            ...
            padding: 20px;
            background-color: rgba(12, 43, 67,0.5);
            border-radius: 10px;
        }
...
<body>
	...
	<div class="header"> <!--Header-->
		...
		<a href="home.html" class="logo"><img src="C:\Users\202310714\Downloads\WEBDESIGN-20240519T231027Z-001\WEBDESIGN\PICTURES\InFigure.png" width="60" height="50"></a> <!--Logo-->
		<input type="text" id="searchInput" placeholder="Search..."> <!--Search bar-->
	...
	<!--Universal HTML END-->
	<div class="taglines"><h1>Join us</h1></div>
...
<div class="sucess-card">
  <span class="sucess-title"> Sucess</span>
  <p class="sucess-des">succesfully login have fun</p>
    <a href = "home.html"><button class="continue-button">continue</button></a>
</div>
...
<!--Universal HTML Footer START-->
		...
		<div class="footer-cont">
			<div class="footer-row">
				...
				<div class="footer-col">
					<h4>Follow Us</h4>
					<div class="socials">
						<a href="https://www.facebook.com/KenGementiza.2004"><i class="fab fa-facebook fa-2x"></i>Ken Reigo Gementiza</a>
					</div>
				</div>
			</div>
		</div>
	...
	<footer class="footer2">
		<p>© 2024, InFigure. All Rights Reserved.</p>
	</footer>
...
<script>
		...
		//Universal JS END
		   ...
		   //pop up
    const successCard = document.querySelector('.sucess-card');
    const signUpForm = document.querySelector('.form-box:nth-child(1) form');
    const signInForm = document.querySelector('.form-box:nth-child(2) form');
    ...
    continueButton.addEventListener('click', function() {
        ...
        // Clear any other necessary actions
    });
